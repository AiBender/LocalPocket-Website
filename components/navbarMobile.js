          ...
          <div className={styles.inner}>
            <Link href={router.pathname === '/mybusiness' ? 'localpocket' : 'mybusiness'}>
              <motion.button
                ...
                whileTap={{ scale: 1.1 }}
              >
                <h4 className="h4" style={{ color: router.pathname === '/mybusiness' ? '#8CD1C5' : '#5C68D2' }}>
            ...
            <motion.button
              onClick={() => {
                window.location.href = `mailto:info@localpocket-app.co.uk`;
              }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
