  ...
  return (
    <>
      ...
      <Parallax pages={totalPages} style={{ top: '0', left: '0' }} ref={parallaxRef} id="parallaxWeWant">
        ...
        <ParallaxLayer className={styles.section1background}>
          <div className={styles.section1Background} />
        </ParallaxLayer>

        {/* SECTION 1 - TEXT*/}
        <ParallaxLayer className={styles.section1} speed={0.5}>
          <Row>
            <Col xs={12} lg={6} md={6}>
              ...
              <h4 className="h4" style={{ color: '#fff', marginTop: '2vh', fontSize: '20px' }}>
                Local Pocket is a UK loyalty scheme which aims to better connect local businesses with local customers, supporting the
                growth of local economies, and saving customers money, time and effort.
              </h4>
            </Col>
            <Col className={styles.section1Image} xs={12} lg={6} md={6}>
              <img src="/mybusiness1.png" alt="" layout="responsive" objectFit="cover" />
            </Col>
          </Row>
        </ParallaxLayer>
        ...
        <div className={styles.greenTopHalfBackground}>
          <ParallaxLayer offset={offsetS2 + 0.3} speed={-0.3} className={styles.section2}>
            <animated.h1 className="extraLg" style={splitRight}>
              THREE.
            </animated.h1>
          </ParallaxLayer>
          <ParallaxLayer offset={offsetS2 + 0.5} speed={-0.3} className={styles.section2}>
            <animated.h1 className="extraLg" style={splitLeft}>
              SIMPLE.
            </animated.h1>
          </ParallaxLayer>
          <ParallaxLayer offset={offsetS2 + 0.7} speed={-0.3} className={styles.section2}>
            <animated.h1 className="extraLg" style={splitRight}>
              STEPS.
            </animated.h1>
          </ParallaxLayer>

          <ParallaxLayer offset={offsetS2 + 1.27} speed={-0.25} className={styles.section2}>
            ...
            <Row>
              <Col>
                <div className={styles.section2Square}>
                  ...
                  <h4 className="h5" style={{ marginTop: '3vh', textAlign: 'center', color: '#fff' }}>
                    Open the App store or Google Play, search for Local Pocket and download the app. Open the app and log in or create an
              ...
              <Col>
                <div className={styles.section2Square}>
                  ...
                  <h4 className="h5" style={{ marginTop: '3vh', textAlign: 'center', color: '#fff' }}>
                    Discover businesses available near you with our map view. Alternatively search for a product or service to view your
                    local promotions
                  </h4>
                </div>
              </Col>
        ...
        {/* ----------- SECTION 4 - PINS -----------*/}
        <ParallaxLayer sticky={{ start: offsetS4, end: offsetS5 }} className={styles.section3}>
          {/* Main pin */}
        ...
        <ParallaxLayer offset={offsetS3 - 0.1} speed={0} className={styles.section3}>
          <svg height="10vh" style={{ marginLeft: '-30vw' }} viewBox="0 0 967 1447" preserveAspectRatio="xMidYMid slice">
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M483.5 967C750.53 967 967 750.53 967 483.5C967 216.47 750.53 0 483.5 0C216.47 0 0 216.47 0 483.5C0 750.53 216.47 967 483.5 967ZM487.5 625C587.74 625 669 543.74 669 443.5C669 343.26 587.74 262 487.5 262C387.26 262 306 343.26 306 443.5C306 543.74 387.26 625 487.5 625Z"
              fill="#57968B"
            />
          </svg>
        </ParallaxLayer>

        <ParallaxLayer offset={offsetS3 - 0.1} speed={0.15} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.2} speed={0.2} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.13} speed={0.3} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.25} speed={0.4} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.1} speed={0.95} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.35} speed={0.6} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.36} speed={0.7} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.2} speed={1} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.16} speed={0.5} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.12} speed={0.15} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.33} speed={0.25} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.05} speed={0.35} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.47} speed={0.45} className={styles.section3}>
          <svg height="10vh" style={{ marginLeft: '-30vw' }} viewBox="0 0 967 1447" preserveAspectRatio="xMidYMid slice">
            <path d="M483.5 1469L64.7767 726.5L902.223 726.5L483.5 1469Z" fill="#98DCCC" />
            <path
              fillRule="evenodd"
        ...
        <ParallaxLayer offset={offsetS3 - 0.07} speed={0.55} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.52} speed={0.65} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.1} speed={0.75} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.05} speed={0.1} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.49} speed={0.95} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.41} speed={0.13} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.48} speed={0.33} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.18} speed={0.2} className={styles.section3}>
          <svg height="10vh" style={{ marginLeft: '90vw' }} viewBox="0 0 967 1447" preserveAspectRatio="xMidYMid slice">
            <path d="M483.5 1469L64.7767 726.5L902.223 726.5L483.5 1469Z" fill="#98DCCC" />
            <path
              fillRule="evenodd"
        ...
        <ParallaxLayer offset={offsetS3 - 0} speed={0.34} className={styles.section3}>
        ...
        <ParallaxLayer offset={offsetS3 - 0.18} speed={0.28} className={styles.section3}>
        ...
        <ParallaxLayer sticky={{ start: offsetS4, end: offsetS6 }} style={{ display: 'flex', justifyContent: 'center', zIndex: -1 }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'center', width: '1500px', maxWidth: '1500px' }}>
            <animated.img src="/deal.png" alt="Screenshot of..." resize="contain" className={styles.section4Image} style={expandCircle2} />
          </div>
        </ParallaxLayer>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'flex-start', width: '1500px', maxWidth: '1500px' }}>
            <div className={styles.section5Text}>
              ...
              <h4 className="h5" style={{ color: '#fff', textAlign: 'center', marginBottom: '5vh' }}>
                Discover businesses available near you with our map view. Alternatively search for a product or service to view your local
                promotions
              </h4>
              <motion.button
                onClick={() => setShow(true)}
        ...
        {/* SECTION 5 - P */}
        <ParallaxLayer offset={offsetS5} factor={sizeS5} className={styles.section5} style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ display: 'flex', justifyContent: 'flex-end', width: '1500px', maxWidth: '1500px' }}>
        ...
        >
          <div style={{ display: 'flex', justifyContent: 'center', width: '1500px', maxWidth: '1500px' }}>
            <img src="/map.png" alt="Screenshot of..." resize="contain" className={styles.section5Image} />
          </div>
        </ParallaxLayer>

        {/* SECTION 7 - FOOTER */}
        <ParallaxLayer offset={offsetS6} factor={sizeS6} style={{ display: 'flex', alignItems: 'flex-end', zIndex: 3 }}>
          <Footer />
        </ParallaxLayer>
      </Parallax>
    </>
