    ...
    >
      ...
      <Modal.Body className="px-5 py-5">
        ...
        <p className={styles.subtitle}>
          Ready to create your Local Pocket? We are hard at working finish up
          development.
          <br /> <br />
          Be one of the first to find fantastic deals or promote your business
          by signing up below to be informed when we launch!
        </p>
        <br />
        <Form>
