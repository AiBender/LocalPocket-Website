...
function HomeMobile() {
  ...
  return (
    <Parallax pages={totalPages} style={{ top: '0', left: '0' }} ref={parallaxRef}>
      ...
      <ParallaxLayer sticky={{ start: offsetS1, end: offsetS2 }} style={{ zIndex: -1 }}>
        <div className={styles.section1Background} />
      </ParallaxLayer>

      {/* SECTION 1 - TEXT*/}
      <ParallaxLayer className={styles.section1}>
        ...
        <h4 className="h4" style={{ color: '#fff', marginTop: '2vh' }}>
          Local Pocket is a UK loyalty scheme which aims to better connect local businesses with local customers, supporting the growth of
          local economies, and saving customers money, time and effort.
        </h4>
      </ParallaxLayer>

      {/* SECTION 1 - IMAGES*/}
      <ParallaxLayer>
        <img src="/mybusiness1.png" alt="" objectFit="contain" className={styles.section1Image} />
      </ParallaxLayer>

      {/* SECTION 3 BACKGROUND */}
      <ParallaxLayer offset={offsetS3} speed={-0.25} style={{ zIndex: '-1' }}>
        <div className={styles.section3Background} />
      </ParallaxLayer>

      {/* SECTION 3 - TEXT */}
      <ParallaxLayer offset={offsetS3 + 0.3} factor={sizeS3} speed={-0.3} className={styles.section3}>
        <animated.h1 className="extraLg" style={splitRight}>
          THREE.
        </animated.h1>
      </ParallaxLayer>
      <ParallaxLayer offset={offsetS3 + 0.42} factor={sizeS3} speed={-0.3} className={styles.section3}>
        <animated.h1 className="extraLg" style={splitLeft}>
          SIMPLE.
        </animated.h1>
      </ParallaxLayer>
      <ParallaxLayer offset={offsetS3 + 0.54} factor={sizeS3} speed={-0.3} className={styles.section3}>
        <animated.h1 className="extraLg" style={splitRight}>
          STEPS.
        </animated.h1>
      </ParallaxLayer>

      <ParallaxLayer offset={offsetS3 + 0.75} factor={sizeS3} speed={-0.2} className={styles.section3}>
        <h2 className="h2" style={{ textAlign: 'center', color: '#fff' }}>
          Gettings started only takes 3 simple steps!
        </h2>
      </ParallaxLayer>

      <ParallaxLayer offset={offsetS3 + 0.88} factor={sizeS3} speed={-0.2} className={styles.section3}>
      ...
      <ParallaxLayer offset={offsetS3 + 1.27} factor={sizeS3} speed={-0.2}>
        <div className={styles.section3Square}>
          ...
          <h5 className="h5" style={{ marginTop: '2vh', textAlign: 'center', color: '#fff' }}>
            Open the App store or Google Play, search for Local Pocket and download the app. Open the app and log in or create an account to
            get started
          </h5>
        </div>
      </ParallaxLayer>
      ...
      <ParallaxLayer offset={offsetS3 + 1.82} factor={sizeS3} speed={-0.2}>
        <div className={styles.section3Square}>
      ...
      <ParallaxLayer offset={offsetS3 + 2.58} factor={sizeS3} speed={-0.2}>
        <div className={styles.section3Square}>
      ...
      {/* ----------- SECTION 4 - PINS -----------*/}
      <ParallaxLayer sticky={{ start: offsetS4, end: offsetS6 }} factor={sizeS4} className={styles.section4}>
        {/* Main pin */}
      ...
      <ParallaxLayer offset={offsetS4 - 0.1} speed={0} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.2} speed={0.2} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.13} speed={0.3} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.25} speed={0.4} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.1} speed={0.95} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.35} speed={0.6} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.2} speed={1} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.3} speed={0.5} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.33} speed={0.25} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.47} speed={0.45} className={styles.section4}>
        <svg height="10vw" style={{ marginLeft: '-30vw' }} viewBox="0 0 967 1447" preserveAspectRatio="xMidYMid slice">
          <path d="M483.5 1469L64.7767 726.5L902.223 726.5L483.5 1469Z" fill="#98DCCC" />
          <path
            fillRule="evenodd"
      ...
      <ParallaxLayer offset={offsetS4 - 0.07} speed={0.55} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.52} speed={0.65} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.1} speed={0.75} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.05} speed={0.1} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.51} speed={0.13} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.48} speed={0.33} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.18} speed={0.2} className={styles.section4}>
      ...
      <ParallaxLayer offset={offsetS4 - 0.18} speed={0.28} className={styles.section4}>
      ...
      {/* SECTION 5 - L */}
      <ParallaxLayer offset={offsetS5 + 0.4} factor={sizeS5} speed={0} className={styles.section5} style={{ justifyContent: 'flex-start' }}>
      ...
      {/* SECTION 5 - IMAGE */}
      <ParallaxLayer offset={offsetS5 + 0.15} factor={sizeS5} speed={-0.2} className={styles.section5} style={{ justifyContent: 'end' }}>
        <animated.img src="/deal.png" alt="Screenshot of..." resize="contain" className={styles.section5Image} style={expandCircle2} />
      </ParallaxLayer>
      ...
      >
        <img src="/map.png" alt="Screenshot of..." resize="contain" className={styles.section6Image} />
      </ParallaxLayer>
      ...
      {/* SECTION 7 - FOOTER */}
      <ParallaxLayer offset={offsetS7} factor={sizeS7} speed={-0.5}>
        <Footer />
      </ParallaxLayer>
    </Parallax>
  );
